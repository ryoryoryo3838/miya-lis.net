...
import * as AboutMe from "./bin/pages/AboutMe.js";
import * as Aquarium from "./bin/pages/Aquarium.js";
import * as Caml_option from "melange.js/caml_option.js";
import * as Home from "./bin/pages/Home.js";
import * as Link from "./bin/components/Link.js";
import * as MutalLink from "./bin/pages/MutalLink.js";
...
function Index$Router(Props) {
  ...
  switch (match.hd) {
    ...
    case "aquarium" :
      if (!match.tl) {
        return JsxRuntime.jsx(Aquarium.make, {});
      }
      break;
    case "mutual" :
      if (!match.tl) {
        return JsxRuntime.jsx(MutalLink.make, {});
      }
      break;
    case "prev" :
      if (!match.tl) {
        return JsxRuntime.jsx(Home.prev, {});
      }
      break;
  }
